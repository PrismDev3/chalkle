...
(assets/scummvm/games/backyard-soccer/). Use your own copy of the game -
the original CD, or the Backyard Soccer re-release by Mega Cat Studios /
...
1. Generate the manifest the player uses to load them:
     python tools/make-scummvm-manifest.py assets/scummvm/games/backyard-soccer
